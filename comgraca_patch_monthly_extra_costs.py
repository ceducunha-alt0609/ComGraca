...
# Keep the legacy field for compatibility, but introduce month-keyed storage.
rep('''  monthGoal: 500,\n  extraCosts: "",\n  markupPct: 150''', '''  monthGoal: 500,\n  extraCosts: "",\n  extraCostsByMonth: {},\n  markupPct: 150''', 'default monthly extra costs')

# Report needs to persist the selected month's cost.
...
# Insert month-specific editor beside month selector in the report toolbar.
...
# Clarify the old Config field and make it edit the current month's bucket.
...
# Pass the setter into ReportTab.
